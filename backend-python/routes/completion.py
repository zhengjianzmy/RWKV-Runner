...
def get_ollama_chat(content: str):
    print("----- standard request -----")
    print("input nlm-60B:")
    print(datetime.now())
    print(content)
    # 目标 URL
    # url = "http://175.27.137.229:11434/api/generate"
    # # 要发送的数据
    # data = {
    #     "model": "nlm-60B",
    #     "prompt": content,
    ...
    url = "http://nlm.luxitech.cn:11434/api/chat"
    # 要发送的数据
    data = {
        "model": "nlm-60B",
        "messages": [
...
async def eval_ollama(
    ...
    while completion_lock.locked():
        ...
        with completion_lock:
            ...
            response = get_ollama_chat(old_content)
